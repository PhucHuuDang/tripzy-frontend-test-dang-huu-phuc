...
export const Input = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          "flex items-center  h-full duration-150 font-sans",
          error
            ? "shadow-error-input hover:shadow-error-input-hover"
            : "border border-[#CCCFD5] hover:border-gray-alpha-500 focus-within:border-transparent focus-within:shadow-focus-input",
          sizes[size],
